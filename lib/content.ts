...
export const copy: Record<Locale, PageCopy> = {
  zh: {
    ...
    projects: [
      ...
      { slug: "tencent-bootcamp", kind: "产品方法训练", title: "腾讯产品经理创造营", subtitle: "系统学习并完成从用户研究、需求真实性判断、产品定位和需求规划，到研发测试、上线验证、数据运营与生命周期管理的全流程训练。", image: "/tencent-pm-banner.png", preview: ["把零散经验转化为完整产品工作框架", "以用户价值、业务目标和实现成本规划需求", "完成入门与进阶 61 / 61 项训练任务"], facts: ["入门 29/29", "进阶 32/32"], cta: "查看方法与证据" },
