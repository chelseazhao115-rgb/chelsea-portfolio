...
export const copy: Record<Locale, PageCopy> = {
  ...
  en: {
    ...
    aboutCards: [
      { id: "photography", title: "Photography", subtitle: "Observation & composition", body: "I notice easy-to-miss light, places and moments, and keep them in photographs.", action: "Open photo book", backTitle: "A ten-page photo journal", image: "/photography-01.jpg", imageAlt: "Chelsea portrait beneath flowering trees", placeholder: "Photography work", gallery: Array.from({ length: 10 }, (_, index) => ({ src: index === 0 ? "/photography-02-landscape.jpg" : `/photography-${String(index + 2).padStart(2, "0")}.jpg`, alt: `Chelsea photography work ${index + 2}` })) },
