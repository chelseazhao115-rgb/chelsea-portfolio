...
export const copy: Record<Locale, PageCopy> = {
  zh: {
    ...
    projects: [
      { slug: "rescue-ducks", kind: "已上线 · 游戏化学习", title: "Rescue Ducks", subtitle: "把雅思阅读中的同义替换训练，从孤立背词重新设计为语义关系游戏。", image: "/rescue-ducks-live.png", preview: ["孤立背词难以迁移到阅读做题", "聚焦语义配对与救援循环的 MVP", "30–40 名学生测试推动引导与颜色支架迭代"], facts: ["55 个学习关卡", "376 组语义词库"], cta: "进入完整案例" },
      { slug: "agora", kind: "AI 学习 Agent", title: "Agora", subtitle: "用六级渐进提示推动学生独立思考，同时控制通用 AI 直接泄露答案。", image: "/agora-live.png", preview: ["家庭学习缺少及时引导，通用 AI 又容易直接给答案", "以六级提示和四类错误定义帮助边界", "建立准确率、幻觉管控与学习提升三维评测"], facts: ["6 级提示", "4 类错误"], cta: "查看产品机制" },
      { slug: "tencent-bootcamp", kind: "产品方法训练", title: "腾讯产品经理创造营", subtitle: "系统学习并完成从用户研究、需求真实性判断、产品定位和需求规划，到研发测试、上线验证、数据运营与生命周期管理的全流程训练。", image: "/tencent-pm.jpg", preview: ["把零散经验转化为完整产品工作框架", "以用户价值、业务目标和实现成本规划需求", "完成入门与进阶 61 / 61 项训练任务"], facts: ["入门 29/29", "进阶 32/32"], cta: "查看方法与证据" },
      { slug: "portfolio", kind: "AI 独立开发", title: "个人网站／作品集", subtitle: "从招聘方快速识别岗位证据的需求出发，独立完成双语信息架构、设计、开发与部署。", image: "/hero-chelsea.png", preview: ["一页简历难以承载产品决策与迭代过程", "按招聘方浏览任务重组信息与证据层级", "完成双语、响应式和可访问性交付"], facts: ["4 个项目档案", "中英双语"], cta: "查看构建过程" },
    ],
    ...
    experiences: [
      ...
      { id: "utu", brand: "UTU", company: "优途雅思", role: "雅思教师", date: "2025.11 — 至今", location: "线上远程", capability: "需求访谈与转化验证", summary: "持续对接不同基础的雅思备考用户，把学习难点与行为痛点转化为试听方案并验证交付逻辑。", actions: ["访谈并分层拆解不同水平学员的备考难点", "沉淀用户需求清单并落地试听教学方案", "根据反馈持续优化试听交付逻辑"], evidence: ["试听转化成功率 90%+", "持续一线服务雅思学习者"], tags: ["用户访谈", "方案验证", "转化优化"], images: [{ src: "/utu-1.jpg", alt: "Chelsea 在优途准备雅思听力课程" }, { src: "/utu-2.jpg", alt: "优途雅思课程准备现场" }], placeholder: "" },
  ...
  en: {
    ...
    projects: [
      { slug: "rescue-ducks", kind: "Live · Gamified learning", title: "Rescue Ducks", subtitle: "Reframing IELTS paraphrase practice from isolated memorisation into a semantic-relationship game.", image: "/rescue-ducks-live.png", preview: ["Isolated vocabulary fails to transfer into reading tasks", "Scoped the MVP around semantic matching and a rescue loop", "30–40 learner tests drove onboarding and colour-scaffold iterations"], facts: ["55 learning levels", "376 semantic groups"], cta: "Enter the full case" },
      { slug: "agora", kind: "AI learning agent", title: "Agora", subtitle: "A six-level Socratic hint system that advances independent thinking while controlling answer leakage.", image: "/agora-live.png", preview: ["Home learning lacks timely help while general AI can reveal too much", "Defined the help boundary through six hint levels and four error types", "Designed evaluation across accuracy, hallucination control and learning gain"], facts: ["6 hint levels", "4 error types"], cta: "Explore the mechanism" },
      { slug: "tencent-bootcamp", kind: "Product methods", title: "Tencent PM Bootcamp", subtitle: "End-to-end training from user research, demand validation, positioning and planning through delivery, launch validation, data operations and lifecycle management.", image: "/tencent-pm.jpg", preview: ["Turned fragmented experience into a complete product workflow", "Prioritised through user value, business goals and delivery cost", "Completed 61 / 61 foundation and advanced tasks"], facts: ["Foundation 29/29", "Advanced 32/32"], cta: "See methods and evidence" },
      { slug: "portfolio", kind: "Independent AI build", title: "Personal portfolio", subtitle: "A bilingual product narrative independently shaped, designed, built responsively and deployed around recruiter needs.", image: "/hero-chelsea.png", preview: ["A one-page resume cannot carry product decisions and iteration", "Reframed information around the recruiter’s scanning task", "Delivered a bilingual, responsive and accessible experience"], facts: ["4 project profiles", "2 languages"], cta: "See the build process" },
    ],
    ...
    "tencent-bootcamp": {
      ...
      process: {
        ...
        steps: [
          ...
          { title: "定义需求", question: "谁在什么场景下需要什么？", method: "验证需求真实性，明确目标用户、核心场景、产品定位、需求本质与暂不解决的边界。", evidence: [{ label: "Rescue Ducks · MVP 边界", status: "applied", href: "/zh/projects/rescue-ducks" }, { label: "Agora · 帮助边界", status: "applied", href: "/zh/projects/agora" }] },
          ...
          { title: "验证价值", question: "上线后如何判断是否有效？", method: "结合反馈、灰度验证、A/B Test、核心指标和异常监控，判断假设是否成立。", evidence: [{ label: "Rescue Ducks · 反馈迭代", status: "applied", href: "/zh/projects/rescue-ducks" }, { label: "Agora · AI 评测", status: "applied", href: "/zh/projects/agora" }, { label: "灰度与 A/B · 课程框架", status: "framework" }] },
