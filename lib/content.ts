...
export const copy: Record<Locale, PageCopy> = {
  zh: {
    ...
    aboutCards: [
      ...
      { id: "dance", title: "舞蹈", subtitle: "舞台与身体表达", body: "我一直喜欢跳舞。练习、记动作和跟上音乐，是工作之外很放松的时刻。", action: "观看舞蹈视频", backTitle: "舞蹈片段", imageAlt: "舞蹈视频封面待补充", placeholder: "舞蹈视频待补充" },
  ...
  en: {
    ...
    aboutCards: [
      ...
      { id: "dance", title: "Dance", subtitle: "Movement & stage", body: "Long-term practice made me comfortable with feedback, decomposition and the pacing of an experience.", action: "Watch dance video", backTitle: "Dance reel", imageAlt: "Dance video cover to add", placeholder: "Dance video to add" },
