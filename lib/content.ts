...
export const copy: Record<Locale, PageCopy> = {
  zh: {
    ...
    capabilities: [
      ...
      { mark: "02", title: "产品设计", subtitle: "Shape the product", body: "先确定核心机制和 MVP，也把暂时不做的功能写清楚。", evidence: "Rescue Ducks · 学习循环与 MVP 取舍；Agora · 六级提示与答案边界" },
      { mark: "03", title: "AI 快速构建", subtitle: "Build with AI", body: "我用 AI 编程把想法做成可操作的版本，尽早发现交互和实现问题。", evidence: "独立完成 Rescue Ducks、Agora 原型和这个中英双语网站" },
      { mark: "04", title: "数据与验证", subtitle: "Validate value", body: "我会结合用户反馈、行为路径、业务指标和评测结果决定下一步。", evidence: "Rescue Ducks · 用户反馈；Agora · 机制与 AI 评测框架，暂无用户效果数据" },
    ],
    projectTitle: "我做过的项目",
    projectIntro: "前两个是我持续打磨的核心项目，后两个记录产品训练和独立开发。",
    projects: [
      { slug: "rescue-ducks", kind: "已上线 · 游戏化学习", title: "Rescue Ducks", subtitle: "一款练习雅思阅读同义替换的词汇游戏。", image: "/rescue-ducks-live.png", highlight: "把孤立背词改成语义配对，并用救援循环完成练习。", facts: ["30–40 名学生试玩", "55 个关卡", "376 组词库"], live: "https://www.rescueducks.xyz", cta: "查看案例" },
      { slug: "agora", kind: "AI 学习 Agent", title: "Agora", subtitle: "面向 IGCSE 数学学习的苏格拉底式 AI Tutor。", image: "/agora-product.png", highlight: "用六级渐进提示控制帮助程度，并按四类错误选择提示起点。", facts: ["6 级提示", "4 类错误", "3 维评测"], stage: "机制与评测验证", cta: "查看产品机制" },
    ...
    aboutCards: [
      { id: "photography", title: "摄影", subtitle: "观察与构图", body: "我喜欢带着相机旅行，也会记录日常里容易错过的光线和细节。", action: "翻开摄影集", backTitle: "九页摄影手记", image: "/photography-camera.jpg", imageAlt: "Chelsea 使用相机进行拍摄", placeholder: "个人摄影作品待补充" },
  ...
  en: {
    ...
    projects: [
      { slug: "rescue-ducks", kind: "Live · Gamified learning", title: "Rescue Ducks", subtitle: "A vocabulary game for practising IELTS Reading paraphrases.", image: "/rescue-ducks-live.png", highlight: "Turns isolated memorisation into semantic matching inside a rescue loop.", facts: ["30–40 student testers", "55 levels", "376 semantic groups"], live: "https://www.rescueducks.xyz", cta: "View case" },
      { slug: "agora", kind: "AI learning agent", title: "Agora", subtitle: "A Socratic AI tutor for IGCSE Mathematics.", image: "/agora-product.png", highlight: "Uses six progressive hint levels and four error types to control how much help is given.", facts: ["6 hint levels", "4 error types", "3 evaluation dimensions"], stage: "Mechanism and evaluation validation", cta: "Explore the mechanism" },
